...
contract Setup is Test {
    ...
    function _updateStorage(uint256 amount_) internal {
...
contract TestMintableTokenLimitExecutionHook is Setup {
    function testUpdateLimitParams() external {
        MockYieldBridgeHook.LimitParams memory burnLimitParams = hook__
            .getSendingLimitParams(_connector);
        MockYieldBridgeHook.LimitParams memory mintLimitParams = hook__
